...
const submutContact = document.querySelector(".contact__form-submit");
...
submutContact.addEventListener("click", function (e) {
  e.preventDefault();
  console.log("clicked");
});
const navMenu = document.querySelectorAll(".main-header__sm-scr-nav-btn-line");
